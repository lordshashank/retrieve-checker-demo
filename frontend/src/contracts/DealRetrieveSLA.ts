...
export const DealRetrieveSLA = {
  address: process.env.NEXT_PUBLIC_DEAL_RETRIEVE_CONTRACT as `0x${string}` || '0x4205AB4d4bfdF8346a9D6b290a3b8229642e2F1F', // Replace with your actual contract address
   abi: [
    {
      "inputs": [
        {
